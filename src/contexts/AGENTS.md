...
- `AIContext` owns conversational state, pending AI creation drafts, confirmation handling, and orchestration of approved project/task writes through `ProjectContext`.
